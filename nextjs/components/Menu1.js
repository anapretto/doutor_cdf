        ...
        <header>
          <nav className="navbar-expand-lg navbar fixed-top d-block p-3 zindex">
            <div className="container">
              ...
              <div className="offcanvas offcanvas-end fundo-geral" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                <div className="offcanvas-header">
                  <h5 className="offcanvas-title" id="offcanvasNavbarLabel"><img src="/logo-cdf-off.svg" alt="" /></h5>
